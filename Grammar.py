...
#
#S %= E, None, None
#E %= E + plus + T, None, None, None, None
#E %= T, None, None
#E %= E + minus + T, None, None, None, None
#T %= T + star + F, None, None, None, None
#T %= F, None, None
#T %= T + div + F, None, None, None, None
#F %= num, None, None
#F %= opar + E + cpar, None, None,None, None
##print(G.Productions[0].attributes[0])